...
import { ListeMatchs, Match } from './pages/Match/'
import { ListEquipes, Equipe } from './pages/Equipe'
import { Action, ListAction } from './pages/Action'
...
const Markup = () => {
  ...
  const routes = [
    /// Dashboard
    { url: '', component: Home, roles: ['SUPER_ADMIN'] },
    { url: 'dashboard', component: Home, roles: ['SUPER_ADMIN'] },
    { url: 'dashboard-dark', component: DashboardDark, roles: ['SUPER_ADMIN'] },
    { url: 'wallet', component: MyWallet, roles: ['SUPER_ADMIN'] },
    ...
    },
    {
      ...
      roles: ['SUPER_ADMIN', 'JOUEUR', 'STAFF', 'ORGANISATEUR'],
    },
    { url: 'matchs', component: ListeMatchs, roles: ['SUPER_ADMIN', 'STAFF'] },
    { url: 'match', component: Match, roles: ['SUPER_ADMIN', 'STAFF'] },
    { url: 'equipes', component: ListEquipes, roles: ['SUPER_ADMIN', 'STAFF'] },
    { url: 'equipe', component: Equipe, roles: ['SUPER_ADMIN', 'STAFF'] },
    {
      url: 'actions',
      component: ListAction,
      roles: ['SUPER_ADMIN', 'ARBITRE'],
    },
        ...
        <div className={`${!pagePath ? 'content-body' : ''}`}>
          ...
          >
            <Routes>
              {routes.map((data, i) => {
                data.roles &&
                  console.log(user.role, data.roles.includes(user.role))
