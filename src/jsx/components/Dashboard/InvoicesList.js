    ...
    <>
      <div className="d-flex mb-3">
        ...
        <Link to={'#'} className="btn btn-outline-primary mb-3">
          <i className="fa fa-calendar me-3 scale3"></i>Filter Date
            ...
            >
              ...
              <tbody>
                <tr role="row" className="odd">
                  ...
                  <td>
                    <span className="text-black font-w500">#123412451</span>
                  </td>
                  <td>
                  ...
                  <td>
                    <span className="text-black">xyzstore@mail.com</span>
                  </td>
                  <td>
                    <span className="text-black">Server Maintenance </span>
                  </td>
                  <td>
                ...
                <tr role="row" className="even">
                  ...
                  <td>
                    <span className="text-black">hawkins@mail.com</span>
                  </td>
                  <td>
                    <span className="text-black">Clean Up </span>
                  </td>
                  <td>
                    <Link to={'#'} className="btn btn-success light">
                      Completed
                ...
                <tr role="row" className="even">
                  ...
                  <td>
                    <span className="text-black">kevin@mail.com</span>
                  </td>
                  <td>
                    <span className="text-black">Upgrade Component </span>
                  </td>
                  <td>
                ...
                <tr role="row" className="odd">
                  ...
                  <td>
                    <span className="text-black">jons@mail.com</span>
                  </td>
                  <td>
                    <span className="text-black">Server Maintenance </span>
                  </td>
                  <td>
                    <Link to={'#'} className="btn btn-dark light">
                      Canceled
                    </Link>
                  </td>
                  <td>
                ...
                <tr role="row" className="even">
                  ...
                  <td>
                    <span className="text-black">brian@mail.com</span>
                  </td>
                  <td>
                    <span className="text-black">Clean Up</span>
                  </td>
                ...
                <tr role="row" className="odd">
                  ...
                  <td>
                    <span className="text-black">davidhere@mail.com</span>
                  </td>
                  <td>
                    <span className="text-black">Upgrade Component </span>
                  </td>
                ...
                <tr role="row" className="even">
                  ...
                  <td>
                    <span className="text-black">fannystevan@mail.com</span>
                  </td>
                  <td>
                    <span className="text-black">Clean Up</span>
                  </td>
