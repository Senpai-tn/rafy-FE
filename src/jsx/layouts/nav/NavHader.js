    ...
    <div className="nav-header">
      ...
      <div
        ...
        onClick={async () => {
          setToggle(!toggle)
          openMenuToggle()
          const SideBar = document.getElementsByClassName('dlabnav')
          const content = document.getElementsByClassName('content-body')
          SideBar[0].style.width = toggle ? '17rem' : 0
          content[0].style.marginLeft = toggle ? '17rem' : 0
        }}
      >
